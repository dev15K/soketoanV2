                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="loai_noi_nhan" id="loai_noi_nhan"
                                    ...
                                    <option {{ $soquy->loai_noi_nhan == 'ncc' ? 'selected' : '' }} value="ncc">Nhà cung cấp</option>
                                    <option {{ $soquy->loai_noi_nhan == 'kh' ? 'selected' : '' }} value="kh">Khách hàng</option>
                                    <option {{ $soquy->loai_noi_nhan == 'nv' ? 'selected' : '' }} value="nv">Nhân viên</option>
                                </select>
                            </div>
