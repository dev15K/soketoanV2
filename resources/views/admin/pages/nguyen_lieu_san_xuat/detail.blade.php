        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.nguyen.lieu.san.xuat.update', $nguyen_lieu_san_xuat->id) }}">
                        @method('PUT')
                        @csrf
                            ...
                            <select id="phieu_san_xuat_id" name="phieu_san_xuat_id" class="form-control">
                                @foreach($phieu_san_xuats as $phieu_san_xuat)
                                    <option
                                        ...
                                        value="{{ $phieu_san_xuat->id }}">{{ $phieu_san_xuat->ten_phieu }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="chi_tiet_khac" id="chi_tiet_khac" class="form-control"
                                      rows="5">{{ $nguyen_lieu_san_xuat->chi_tiet_khac }}</textarea>
                        </div>
